...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.08282, 80.27072, heading 45.0 deg, then a different position on the very next read, from the same (absent) input.
