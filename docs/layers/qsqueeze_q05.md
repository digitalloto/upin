...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.08270, 80.27070, 0.00 m/s, then a different velocity on the very next read, from the same (absent) input.
