...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.08273, 80.27072, heading 45.4 deg, then a different position and heading on the very next read, from the same (absent) input.
