...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.07098, 80.25429, then a different position on the very next read, from the same (absent) input.
