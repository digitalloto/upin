...
Measured by constructing this layer with nothing attached and reading it three times: returned 50.08 m/s, then a different velocity on the very next read, from the same (absent) input.
