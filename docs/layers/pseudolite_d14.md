...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.08271, 80.27066, then a different position on the very next read, from the same (absent) input.
