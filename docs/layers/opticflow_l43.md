...
Measured by constructing this layer with nothing attached and reading it three times: returned 10.13 m/s, then a different velocity on the very next read, from the same (absent) input.
