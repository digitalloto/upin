...
Measured by constructing this layer with nothing attached and reading it three times: returned heading 45.2 deg, then a different heading on the very next read, from the same (absent) input.
