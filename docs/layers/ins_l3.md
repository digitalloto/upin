...
Measured by constructing this layer with nothing attached and reading it three times: returned 13.08269, 80.27067, 0.02 m/s, heading 45.0 deg, then a different position and velocity and heading and confidence on the very next read, from the same (absent) input.
